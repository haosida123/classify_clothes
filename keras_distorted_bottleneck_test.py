...
if __name__ == "__main__":
    ...
    a.add_argument("--save_image_perthousand", default=5000, type=int)
    a.add_argument("--times_per_image", default=10, type=int)
    ...
    (ROTATION_RANGE, WIDTH_SHIFT_RANGE, BRIGHTNESS_RANGE, SHEAR_RANGE, HORIZONTAL_FLIP) =\
